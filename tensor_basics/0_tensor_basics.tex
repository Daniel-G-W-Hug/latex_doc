...
\newcommand{\hdv}{\ensuremath{\textcolor{YellowOrange}{\vec{v}}}}
...
\input{1_transformation_rules.tex}
\input{2_vector_definition.tex}
\input{3_covector_definition.tex}
\input{4_linear_maps.tex}
\input{5_metric_tensor.tex}
\input{6_general_tensors.tex}
